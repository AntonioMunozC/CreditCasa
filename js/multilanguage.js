...
let langs = document.querySelector(".langs");
     ...
     contact = document.querySelector("#contact-header");
     ...
     calchoose = document.querySelector("#calchoose");
     calmonthsstart = document.querySelector("#calmonthsstart");
     calmonthsend = document.querySelector("#calmonthsend");
     calresulttitle = document.querySelector("#calresulttitle");
     calresultmonths = document.querySelector("#calresultmonths");
     calrequest = document.querySelector("#calrequest");
...
let data = {
     spanish: {
          ...
          opportunities:"Oportunidades inmobiliarias únicas",
          locate:"Ubicación",
          ...
          //CALCULADORA
          caltitle:"Calcula tu crédito",
          calchoose:"Elije el periodo del crédito",
          calmonthsstart:"5 meses",
          calmonthsend:"60 meses",
          calresulttitle:"Tú crédito por tan sólo:",
          calresultmonths:"mensualidades",
          calrequest:"Solicitar crédito",
          //
     ...
     english: {
          ...
          opportunities:"Unique real estate opportunities",
          locate:"Location",
          ...
          //CALCULADORA
          caltitle:"Calculate your credit",
          calchoose:"Choose the credit period",
          calmonthsstart:"5 months",
          calmonthsend:"60 months",
          calresulttitle:"Your credit for just:",
          calresultmonths:"monthly payments",
          calrequest:"Apply for credit",
          //
     ...
     french: {
          ...
          opportunities:"Des opportunités immobilières uniques",
          locate:"Emplacement",
          ...
          //CALCULADORA
          caltitle:"Calculez votre crédit",
          calchoose:"Choisissez la durée du crédit",
          calmonthsstart:"5 mois",
          calmonthsend:"60 mois",
          calresulttitle:"Votre crédit pour seulement :",
          calresultmonths:"mensualités",
          calrequest:"Faire une demande de crédit",
          //
...
link.forEach(el=>{
     el.addEventListener("click", ()=>{
          ...
          if(attr!==idiom){
           ...
           opportunities.innerHTML = data[idiom].opportunities
           ...
           caltitle.innerHTML = data[idiom].caltitle
           calchoose.innerHTML = data[idiom].calchoose
           calmonthsstart.innerHTML = data[idiom].calmonthsstart
           calmonthsend.innerHTML = data[idiom].calmonthsend
           calresulttitle.innerHTML = data[idiom].calresulttitle
           calresultmonths.innerHTML = data[idiom].calresultmonths
           calrequest.innerHTML = data[idiom].calrequest
